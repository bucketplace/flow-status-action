...
exports.checkDeliveryFlowStatus = void 0;
...
function checkDeliveryFlowStatus(application, flow) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield node_fetch_1.default(`${getBaseUrl()}/applications/${application}/delivery/${flow}/status`, {
            method: 'GET',
            headers: {
...
exports.checkDeliveryFlowStatus = checkDeliveryFlowStatus;
...
const delivery_flow_1 = __nccwpck_require__(194);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const application = core.getInput('application', { required: true });
            const flow = core.getInput('flow', { required: true });
            core.debug(`Check delivery ${flow} flow status for application ${application}`);
            yield delivery_flow_1.checkDeliveryFlowStatus(application, flow);
        }
        catch (error) {
